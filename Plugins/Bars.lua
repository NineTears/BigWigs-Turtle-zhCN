...
L:RegisterTranslations("enUS", function()
    ...
    ["Reverse"] = "反转",
    ["Toggles if bars are reversed (fill up instead of emptying)."] = "切换是否反转进度条（填充而不是排空）",
    ["Emphasize"] = "重点",
    ["Emphasize bars that are close to completion (<10sec). Also note that bars started at less than 15 seconds initially will be emphasized right away."] = "突出接近完成的进度条（<10秒）。同时请注意，最初在15秒内开始的进度条将立即突出显示.",
    ["Enable"] = "启用",
    ["Enables emphasizing bars."] = "启用重点进度条。",
    ["Flash"] = "闪光",
    ["Flashes the background red for bars that are emphasized."] = "对于重点进度条，闪烁背景为红色。",
    ["Move"] = "移动", 
    ["Move bars that are emphasized to a second anchor."] = "将重点进度条移动到第二个锚点。",
    ["Set the scale for emphasized bars."] = "设置重点进度条比例.",
    ["Emphasize Bars"] = "高亮计时条",
    ["Enable IntervalBars"] = "启用计时条",
...
function BigWigsBars:SetupFrames(emphasize)
	...
	if emphasize then
		...
		self.frames.emphasizeAnchor.cheader:SetText("插件 -> 状态条 -> 高亮计时条")
