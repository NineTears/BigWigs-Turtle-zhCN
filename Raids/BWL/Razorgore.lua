...
L:RegisterTranslations("enUS", function() return {
    ...
    polymorph_message = "%s 被变形了！快驱散！",
    polymorph_message_you = "你被变形了！",
    polymorph_bar = "变形术: %s",
    ...
    ["Eggs destroyed"] = true,
    ["Eggs destroyed"] = "龙蛋已摧毁",

    mc_cmd = "mindcontrol",
    mc_name = "精神控制",
    mc_desc = "通报谁被精神控制并开始一个可点击的计时条以便选取。",

    eggs_cmd = "eggs",
    eggs_name = "龙蛋",
    eggs_desc = "统计摧毁的黑龙蛋数量。",
    ...
    mobs_cmd = "mobs",
    mobs_name = "首波敌人",
    mobs_desc = "显示首波敌人何时出现。",

    orb_cmd = "orb",
    orb_name = "宝珠控制",
    orb_desc = "显示谁在控制Boss并开始一个可点击的计时条以便选取。",

    fireballvolley_cmd = "fireballvolley",
    fireballvolley_name = "火球齐射",
    fireballvolley_desc = "通报Boss正在施放火球齐射。",

    conflagration_cmd = "conflagration",
    conflagration_name = "燃烧",
    conflagration_desc = "开始一个燃烧效果的持续时间计时条。",
